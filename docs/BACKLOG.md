...
- **Centralizar entregas da Sabre** — talvez realizar operações de Upsell e Cross-sell para o cliente diretamente em seu Dashboard. Adiado: Adicionar isso apenas depois do desenvolvimento total do Atrium e outros agentes. Verificar a possibilidade do mesmo pois seria necessário uma venda consultiva.